    ...
    public abstract class BaseObject
    {
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                if (signatureProperties.Any()) return hashCode;
        ...
        public virtual IEnumerable<PropertyInfo> GetSignatureProperties()
        {
            ...
            if (signaturePropertiesDictionary.TryGetValue(GetType(), out properties)) return properties;
        ...
        public virtual bool HasSameObjectSignatureAs(BaseObject compareTo)
        {
            ...
            if ((from property in signatureProperties
                ...
                select valueOfThisObject).Any()) return false;
