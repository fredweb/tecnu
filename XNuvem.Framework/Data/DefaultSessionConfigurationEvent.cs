...
namespace XNuvem.Data
{
    ...
    /// </summary>
    public class DefaultSessionConfigurationEvents : ISessionConfigurationEvents
    {
        /// <summary>
        ...
        /// <summary>
        ///     Called when configuration hash is being computed. If hash changes, configuration will be rebuilt and stored in
        ///     mappings.bin.
